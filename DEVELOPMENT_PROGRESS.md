...
- 마지막 갱신: 2026-08-26
- 현재 완료 범위: 단계 0~18, 비동기 시작 로딩, 종료·저장 정책 및 농장 구름 그림자 구현
- 다음 작업: 구름 그림자와 ESC 종료·침대 전용 저장 실제 GUI 검증
- 제출 크기 상한: `1,474,560 bytes`
- 현재 Release EXE: `91,648 bytes`
- 현재 `data.pak`: `359,360 bytes`
- 현재 대표 save: `155 bytes`
- 현재 합계: `451,163 bytes`
- 남은 공간: `1,023,397 bytes`
