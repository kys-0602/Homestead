...
- Release EXE `102,400 bytes` (`+2,048 bytes`), pak `366,132 bytes` (`+84 bytes`), 대표 save `173 bytes` (변화 없음).
- 실제 제출 합계 `468,705 bytes` (`+2,132 bytes`), 상한까지 `1,005,855 bytes` 남음.
- EXE SHA-256: `115bb880e846329a431a6909a2229036a4953006a25a802e1578feefb97a5e17`
