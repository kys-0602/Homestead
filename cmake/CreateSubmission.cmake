foreach(required binary_path pak_path save_path readme_path submission_directory manifest_path submission_limit)
...
foreach(input binary_path pak_path save_path readme_path)
    if(NOT EXISTS "${${input}}")
...
file(COPY "${binary_path}" "${pak_path}" "${save_path}" "${readme_path}" DESTINATION "${submission_directory}")

set(total_size 0)
set(manifest "Homestead final submission\n")
foreach(name Homestead.exe data.pak representative.sav README.txt)
